...
compute_cum_effectss <- function(posterior_list, panel_data_Y, panel_data_D) {
...
cum_effects_assign <- compute_cum_effectss(list_assign_model, panel_list$Y, panel_list$D)
cum_effects_outcome_only <- compute_cum_effectss(list_outcome_only, panel_list$Y, panel_list$D)
